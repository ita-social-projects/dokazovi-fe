export const editor = {
  ...
  textLength: 'Довжина тексту: {{count}} символ, мінімальна довжина тексту 50 символів',
  textLength_0: 'Мінімальна довжина тексту 50 символів, довжина тексту: {{count}} символ, ',
  textLength_1: 'Мінімальна довжина тексту 50 символів, довжина тексту: {{count}} символи, ',
  textLength_2: 'Мінімальна довжина тексту 50 символів, довжина тексту: {{count}} символів, ',
