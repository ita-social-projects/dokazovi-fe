export const admin = {
  ...
  activateUserAccount: `Активувати користувача`,
  deactivateUserAccount: `Деактивувати користувача`,
  activateOrCreateUserAccount: `Акаунт користувача вже існує, ви хочете активувати акаунт чи створити новий?`,
  createUserAccount: `Створити новий акаунт`,
  activateExistingAccount: `Активувати існуючий акаунт`,
  sendEmailToCreateUserAccount: `Відправити`,
